...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                new Product(){ProductId = 1, CategoryId = 2, ImageUrl = "/images/desktop.jpg", ProductName = "Computer", Price = 17_000, ShowCase = false},
                ...
                new Product(){ProductId = 5, CategoryId = 2, ImageUrl = "/images/headset.jpg", ProductName = "Headset", Price = 1_500, ShowCase = false},
                new Product(){ProductId = 6, CategoryId = 1, ImageUrl = "/images/history.jpg", ProductName = "History", Price = 50, ShowCase = false},
                new Product(){ProductId = 7, CategoryId = 1, ImageUrl = "/images/hamlet.jpg", ProductName = "Hamlet", Price = 80, ShowCase = true}
            );
        }
    }
}